  ...
  return (
    <div className="fixed inset-0 bg-black/30 z-[60] flex items-center justify-center p-4 animate-fadeIn">
      ...
      >
        ...
        <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-8 text-center relative overflow-hidden">
          {/* Decorative Elements */}
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg">
            ...
            <div className="space-y-1 text-sm">
              <p className="text-gray-700">
                <span className="font-semibold">Order Number:</span> <span className="text-blue-600 font-bold">{orderData.order_number || orderData.id}</span>
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white p-6 rounded-xl shadow-lg">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex-1 flex items-center justify-center gap-2 bg-white text-orange-600 py-3 px-4 rounded-lg hover:bg-orange-50 transition-colors font-semibold"
              >
                <PhoneIcon className="h-6 w-6" />
                Call
              </a>
              <a
                href="https://wa.me/8801521330152"
                target="_blank"
