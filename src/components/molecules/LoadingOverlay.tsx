      ...
      <div className="bg-white rounded-2xl p-10 shadow-2xl flex flex-col items-center gap-6 animate-slideUp">
        ...
        <div className="relative w-24 h-24">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-12 h-12 border-4 border-purple-300 rounded-full border-t-transparent animate-spin" style={{ animationDirection: 'reverse', animationDuration: '0.8s' }}></div>
          </div>
        </div>
